...
<body class="">
                        ...
                        <div class="card-body">
                            <form role="form" class="user" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-check form-switch mb-3">
                                    <input class="form-check-input" type="checkbox" name="role" role="switch"
                                        id="flexSwitchCheckDefault" value="seller">
                                    <label class="form-check-label text-dark font-weight-bolder"
                                        for="flexSwitchCheckDefault">Seller</label>
                                </div>
                                <div class="mb-3 d-none" id="conditionalInputContainer">
                                    <input type="text" class="form-control" id="conditionalInput" name="store_name"
                                        placeholder="Store Name">
                                </div>
                                <div class="form-check form-check-info text-start">
                                    <input class="form-check-input" type="checkbox" name="TnC" id="flexCheckDefault">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const conditionalInput = document.getElementById('conditionalInputContainer');

            toggleSwitch.addEventListener('change', function () {
                if (this.checked) {
                    conditionalInput.classList.remove('d-none');
                } else {
                    conditionalInput.classList.add('d-none');
                }
            });
        });
    </script>
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const toggleSwitch = document.getElementById('flexCheckDefault');
